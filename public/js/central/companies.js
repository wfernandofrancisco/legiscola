...
document.addEventListener('DOMContentLoaded', function () {
    (function () {
        // ── Elementos do DOM ────────────────────────────────────────────────
        const companiesTableWrapper = document.getElementById('companies-table-wrapper');
        ...
        function buildParams() {
            ...
            const sortByInput = companyFilterForm?.querySelector('[name="sort_by"]');
            const sortDirInput = companyFilterForm?.querySelector('[name="sort_dir"]');
        ...
        function loadTable(url) {
            if (!companiesTableWrapper) return;

            companiesTableWrapper.style.opacity = '0.5';
            ...
            fetch(url, {
                ...
                .then(html => {
                    companiesTableWrapper.innerHTML = html;
                    companiesTableWrapper.style.opacity = '1';
        ...
        document.addEventListener('click', function (e) {
            const link = e.target.closest('#companies-table-wrapper a[href]');
        ...
        window.openCompanyModal = function (url) {
            const modal = document.getElementById('company-show-modal');
            const content = document.getElementById('company-show-content');
            const fullLink = document.getElementById('company-show-full-link');
