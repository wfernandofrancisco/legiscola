        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <div class="mt-2 rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-2 text-xs text-indigo-800 dark:border-indigo-800 dark:bg-indigo-950/40 dark:text-indigo-200">
                    ...
                    <p><strong>Tipo curso:</strong> <code>@{{curso_nome}}</code>, <code>@{{carga_horaria}}</code>, <code>@{{data_conclusao}}</code>, <code>@{{professor_nome}}</code>, etc. <strong>Tipo evento:</strong> use <code>@{{evento_nome}}</code> e <code>@{{aluno_nome}}</code> para o participante; <code>@{{professor_nome}}</code> ou <code>@{{palestrante_nome}}</code> para quem ministrou. <strong>Tipo palestrante:</strong> use <code>@{{palestrante_nome}}</code> (ou <code>@{{aluno_nome}}</code>), <code>@{{evento_nome}}</code> e opcionalmente <code>@{{palestrante_cpf}}</code>.</p>
