...
@section('content')
    <x-portal.auth-frame
        ...
        subtitle="Informe o e-mail da sua conta. Enviaremos um link seguro para você definir uma nova senha."
    >
        @if ($errors->any())
        ...
        <p class="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
            <a href="{{ route('portal.acesso.login') }}" class="font-semibold underline underline-offset-2" style="color:var(--portal-primary)">Voltar ao login</a>
        </p>
    </x-portal.auth-frame>
@endsection
