...
class StoreTenantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'invite_name_1' => ['nullable', 'string', 'max:255', 'required_with:invite_email_1'],
            'invite_email_1' => ['nullable', 'email', 'max:255', 'unique:users,email', 'required_with:invite_name_1'],
            'invite_cargo_1' => ['nullable', 'string', 'max:100'],
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            ...
            'invite_name_1' => 'nome do usuário convidado',
            'invite_email_1' => 'e-mail do usuário convidado',
            'invite_cargo_1' => 'cargo',
        ];
    }
}
